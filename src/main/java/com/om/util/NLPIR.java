...
public class NLPIR {
	...
	public interface CLibrary extends Library {
		...
		CLibrary Instance = (CLibrary) Native.loadLibrary(
				"E:\\eclipse\\NetworkPublicOpinionMap\\Data\\NLPIR", CLibrary.class);
	...
	public static void main(String[] args) throws Exception {
		...
		String sInput = "据悉，质检总局已将最新有关情况再次通报美方，1 要求美方加强对输华玉米的产地来源、运输及仓储等环节的管控措施，有效避免输华玉米被未经我国农业部安全评估并批准的转基因品系污染。";
