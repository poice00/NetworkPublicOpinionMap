...
public class CustomSegmentation {
	public static void main(String argv[]) throws Exception {
		...
		System.out.println(api.analyzeGetResult("他是个骄傲的人"));
	}
	...
	public void analyze(String filename) {
		try {
			...
			while (line != null) {
				...
				String api_key = "w361X930Kq7QiHGuixmRggkVSTnEbEJjAx8PxsXq";
				// String pattern = "all";
				// String format = "xml";
				String pattern = "dp";
				String format = "plain";
				...
				String content = ("api_key=" + api_key + "&" + "text=" + text
	...
	public String analyzeGetResult(String str) throws Exception {
