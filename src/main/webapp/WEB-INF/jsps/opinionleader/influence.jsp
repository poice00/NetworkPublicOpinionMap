...
<div class="panel panel-default">
	<div class="page-header">
		<a href="<%=request.getContextPath()%>/leader/influence"><button type="button" class="btn btn-default active">影响力</button></a>
		...
		<h1 align="center">影响力排行Top-10</h1>
	</div>
		...
		<table class="table table-hover">
			...
			<c:forEach items="${resultList}" var="item">
				<tr>
						...
						<td><fmt:parseNumber type="number" value="${item.brosesTimes}" /></td>
						<td><fmt:parseNumber type="number" value="${item.tipReplyNum}" /></td>
						<td><fmt:parseNumber type="number" value="${item.fansNum}" /></td>
						<td>${item.authorInfluence}</td>
				</tr>
			</c:forEach>
